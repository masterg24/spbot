...
var prefix = "s."
var adminprefix = 'sp.' // Alpha Codes Ghost
...
client.on('message', message => {
  ...
  message.channel.sendEmbed(embed);  // Alpha Codes Ghost
   ...
   client.on("message", message => {
      if (message.content === "s.help") {  // Alpha Codes Ghost
...
client.on('message', message => {
    if (message.content.startsWith("s.avatar")) {  // Alpha Codes Ghost
...
client.on('message', message => {
    if (message.content.startsWith("s.bans")) {  // Alpha Codes Ghost
...
const developers = ["401441334864510986"]
client.on('message', message => {
